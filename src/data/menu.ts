    ...
    items: [
      {
        ...
        nameLine1: 'Kuřecí',
        nameLine2: 'burrito',
        description: 'Tortilla plněná šťavnatým kuřecím masem, rajčaty, paprikou, salátem, fazolemi, cibulkou, mixem sýrů, jalapeños a enchilada omáčkou.',
      ...
      },
      {
        ...
        nameLine1: 'Vepřové',
        nameLine2: 'burrito',
        description: 'Tortilla plněná jemnou vepřovou panenkou, fazolemi, zeleninou, červenou i bílou cibulkou, mixem sýrů, jalapeños a enchilada omáčkou.',
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        nameLine1: 'Vepřová',
        nameLine2: 'quesadilla',
        description: 'Zapečená tortilla s vepřovou panenkou, mixem sýrů, rajčaty, cibulkou, jalapeños a salsou.',
    ...
    items: [
      {
        ...
        nameLine1: 'Nachos',
        nameLine2: 'se salsou',
        description: 'Kukuřičné chipsy se svěží rajčatovou salsou.',
      ...
      },
      {
        ...
        nameLine1: 'Nachos',
        nameLine2: 'se sýrem',
        description: 'Kukuřičné chipsy zapečené se sýrem a rajčatovou salsou.',
      ...
      },
      {
        ...
        description: 'Kukuřičné chipsy zapečené se sýrem, čerstvou zeleninou a rajčatovou salsou.',
